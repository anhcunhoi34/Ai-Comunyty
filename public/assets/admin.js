...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    module_default$1.data('user', function (user) {
      return {
        ...
        init: function init() {
          var _this = this;
          this.user = user;
          this.model = _objectSpread2({}, this.user);
          this.required.forEach(function (field) {
        ...
        update: function update() {
          ...
          var data = this.model;
          data.status = data.status ? 1 : 0;
          api.post("/users/".concat(this.user.id), this.model).then(function (response) {
        ...
        create: function create() {
          var _this3 = this;
          api.post('/users', this.model).then(function (response) {
  ...
  function settingsView() {
    module_default$1.data('settings', function () {
      return {
        required: [],
        isProcessing: false,
        isSubmitable: false,
